...
def evaluate_model(config):
    ...
    model.load_state_dict(torch.load("models/best_model_gru.pth"))
    model.eval()
    ...
    with open("results/metrics_gru.txt", "w") as f:
    ...
    plt.legend()
    plt.savefig("results/predictions_gru.png")
    plt.close()
    ...
    plt.savefig("results/probability_distribution_gru.png")
    plt.close()
